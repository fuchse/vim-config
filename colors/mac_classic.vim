...
hi VertSplit  guifg=#FFFFFF ctermfg=15 guibg=#AFAFAF ctermbg=252 gui=NONE
hi MatchParen  guifg=#1E39F6 ctermfg=27 guibg=#CFCFCF gui=bold
...
hi StatusLineNC  guifg=#000000 ctermfg=0 guibg=#AFAFAF ctermbg=7 gui=NONE
